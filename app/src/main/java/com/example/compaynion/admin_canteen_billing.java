...
CanteenBack2=(Button) findViewById(R.id.back_Canteen_Manage);
        ...
        //intent to go back to Canteen page from Canteen_Manage page  on click of button
        CanteenBack2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i15 = new Intent(admin_canteen_billing.this,admin_canteen.class);
                startActivity(i15);
            }
        });
    }
